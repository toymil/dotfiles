...
function els { eza --icons=never --color=auto --color-scale=all --color-scale-mode=gradient --classify=auto --all --sort=name --group-directories-first --long --binary --no-quotes --sort=size --time-style='+%Y-%m-%d %H:%M:%S %:z' @args }
